...
- [1. 课程目标](#1-课程目标)
- [2. 核心内容](#2-核心内容)
  - [一、vLLM 解决的核心痛点](#一vllm-解决的核心痛点)
  - [1.1 传统推理的三大痛点](#11-传统推理的三大痛点)
  - [1.2 vLLM 的突破性创新](#12-vllm-的突破性创新)
  - [1.3 nano-vllm](#13-nano-vllm)
  - [二、系统架构概览](#二系统架构概览)
  - [三、一条请求的全流程拆解](#三一条请求的全流程拆解)
  - [关于 Tokenizer：文本与 Token 的桥梁](#关于-tokenizer文本与-token-的桥梁)
  - [四、Prefill 与 Decode 的差异化处理](#四prefill-与-decode-的差异化处理)
  - [五、动手实践：nano-vllm 源码入口指引](#五动手实践nano-vllm-源码入口指引)

## 1. 课程目标

- **理解 vLLM 的核心设计理念**：为什么要专门搞一个推理引擎，而不是直接拿 PyTorch 写个 generate 循环就完事？这背后涉及到传统方法遇到的实实在在的性能瓶颈，以及 vLLM 如何用一套受操作系统启发的设计来解决这些问题。

- **理清推理流程的全生命周期**：一个 prompt 进来之后，到底经历了哪些步骤才变成最终输出？
...
![](../_assets/Inference-%E6%8E%A8%E7%90%86%E5%9F%BA%E7%A1%80%E8%AE%BE%E6%96%BD/01-kv-cache-fragmentation.png)
...
![](../_assets/Inference-%E6%8E%A8%E7%90%86%E5%9F%BA%E7%A1%80%E8%AE%BE%E6%96%BD/02-static-batching.jpg)
...
![](../_assets/Inference-%E6%8E%A8%E7%90%86%E5%9F%BA%E7%A1%80%E8%AE%BE%E6%96%BD/03-memory-waste.png)
...
![](../_assets/Inference-%E6%8E%A8%E7%90%86%E5%9F%BA%E7%A1%80%E8%AE%BE%E6%96%BD/04-paged-attention.png)
...
![](../_assets/Inference-%E6%8E%A8%E7%90%86%E5%9F%BA%E7%A1%80%E8%AE%BE%E6%96%BD/05-without-continuous-batching.png)

**with continious batching**

![](../_assets/Inference-%E6%8E%A8%E7%90%86%E5%9F%BA%E7%A1%80%E8%AE%BE%E6%96%BD/06-with-continuous-batching.png)
...
![](../_assets/Inference-%E6%8E%A8%E7%90%86%E5%9F%BA%E7%A1%80%E8%AE%BE%E6%96%BD/07-nano-vllm-architecture.png)
...
![](../_assets/Inference-%E6%8E%A8%E7%90%86%E5%9F%BA%E7%A1%80%E8%AE%BE%E6%96%BD/08-request-lifecycle.png)
...
![](../_assets/Inference-%E6%8E%A8%E7%90%86%E5%9F%BA%E7%A1%80%E8%AE%BE%E6%96%BD/09-kv-cache-prefill-decode.png)
...
![](../_assets/Inference-%E6%8E%A8%E7%90%86%E5%9F%BA%E7%A1%80%E8%AE%BE%E6%96%BD/10-prefill-vs-decode.png)
