...
关联阅读：可结合 [Agent 核心问题](Agent%20%E6%A0%B8%E5%BF%83%2016%20%E9%97%AE.md) 理解；Tools 与协议是 Agent 执行闭环的行动接口。
...
- **系统位置**：[Agent 核心问题](Agent%20%E6%A0%B8%E5%BF%83%2016%20%E9%97%AE.md) — Tools 与协议是 Agent 执行闭环的行动接口。
- **对比**：[A2A](A2A.md) — 工具协议和 A2A 分别解决不同层级的互操作。
- **对比**：[Skill_10](Agent%20Skill%20%E6%9C%BA%E5%88%B6.md) — 工具协议解释了 Skill 最终调用动作的运行边界。
